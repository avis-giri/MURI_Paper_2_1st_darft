...
Which temperatures matter depends on the season, and the distinction is worth
stating carefully. Over the complete instrumented record from 2017 to 2026, the
ground at the three network sites is sub-zero on just over half of all days and
reaches \SI{-27.5}{\degreeCelsius}, with only \SI{37}{\percent} to
\SI{58}{\percent} of sub-zero time warmer than \SI{-5}{\degreeCelsius}. During
the freeze-up season alone, however, \SI{86}{\percent} and \SI{88}{\percent} of
sub-zero time at the two boreal forest sites is warmer than
\SI{-5}{\degreeCelsius}. Deep winter is colder than the retrieval can reach.

That is a scope statement rather than a limitation. The freezing curve governs
behaviour during freeze-up and thaw, when latent heat is released and the
liquid fraction is changing; by midwinter the soil sits at its residual
unfrozen water content and the curve is flat. The transition seasons are also
the only part of the cold season with usable solar illumination at
\ang{65} north. We therefore propose sampling the ladder from the freeze-up
residence-time distribution: closely spaced between \SI{0}{\degreeCelsius} and
\SI{-2}{\degreeCelsius} where the index changes fastest, sparser out to
\SI{-5}{\degreeCelsius}, and a small number of colder points retained to
characterize the residual regime that midwinter and exposed tundra represent.
